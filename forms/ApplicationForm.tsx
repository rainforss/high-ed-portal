              ...
              >
                ...
                {!isProgramsLoading && (
                  <>
                    ...
                    <SelectInput
                      ...
                      id="programId"
                      name="programId"
                      label="York School of Continuing Studies Program"
                      disabled={!!applicationId}
                      w="50%"
                      p="1rem"
                    />
                ...
                {!isProgramsLoading && (
                  <ToggleInput
                    ...
                    label="Have you applied to a traditional program at York University"
                    disabled={!!applicationId}
                    w="100%"
                    p="1rem"
                    py="2rem"
                ...
                {!isProgramsLoading && !!values.appliedToTraditional && (
                  <SelectInput
                    ...
                    label="Which program of York University have you applied for"
                    disabled={!!applicationId}
                    w="100%"
                    p="1rem"
                  />
                ...
                {!isPeriodsLoading && (
                  <SelectInput
                    ...
                    label="In which term would you like to attend to the selected York SCS program"
                    disabled={!!applicationId}
                    w="100%"
                    p="1rem"
                  />
